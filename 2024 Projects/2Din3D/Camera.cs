...
namespace _2Din3D
{
    internal class Camera
    {
        ...
        public Camera(Vector3 target, Vector3 position, float width, float height, float nearPlane, float farPlane, bool canMove, bool playerControlled)
        {
            this.camTarget = target;
            this.camPosition = position;

            this.projectionMatrix = Matrix.CreateOrthographic(width, height, nearPlane, farPlane);
